...
class RequestForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['category', 'vehicle_no', 'vehicle_name',
...
class AdminRequestForm(forms.Form):
    ...
    ), empty_label="Customer Name", to_field_name='id')
    mechanic = forms.ModelChoiceField(queryset=models.Mechanic.objects.all(
    ), empty_label="Mechanic Name", to_field_name='id')
...
class ContactusForm(forms.Form):
    Name = forms.CharField(max_length=30, widget=forms.TextInput(attrs={
        ...
        'style': 'border: none;border-bottom: 1px solid #00c6ff;outline: none;box-shadow: none; color: #00c6ff',
    ...
    Message = forms.CharField(
        max_length=500, widget=forms.Textarea(attrs={'rows': 3, 'cols': 22, 'style': 'border: none;border-bottom: 1px solid #00c6ff;outline: none;box-shadow: none; color: #00c6ff',
